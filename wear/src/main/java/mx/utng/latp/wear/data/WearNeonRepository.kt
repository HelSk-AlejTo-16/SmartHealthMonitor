package mx.utng.latp.wear.data

import kotlinx.coroutines.Dispatchers
import kotlinx.coroutines.withContext
import mx.utng.latp.wear.data.remote.LecturaFcDto
import mx.utng.latp.wear.data.remote.NeonClient
import mx.utng.latp.wear.data.remote.NeonRequest
        ...
        withContext(Dispatchers.IO) {
            ...
            NeonClient.api.executeQuery(
                ...
                request = NeonRequest(
                    ...
                    params = listOf(bpm.toString(), estado, "wear", hora) // Convert bpm to string for generic NeonRequest
                )
            )
